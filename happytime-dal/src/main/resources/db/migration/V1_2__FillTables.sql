...
INSERT INTO product (title, cost, quantity, description, img_link, created_date, last_modified_date, created_by, last_modified_by) VALUES ("Шар красный", 1000, 50,  "Шар круглый красный", "/images/balloons/red_round_balloon.png", NOW(), NOW(), 1, 1);
INSERT INTO product_category (product_id, category_id) VALUES (1, 1);
INSERT INTO product_subcategory (product_id, subcategory_id) VALUES (1, 1);
INSERT INTO product (title, cost, quantity, description, img_link, created_date, last_modified_date, created_by, last_modified_by) VALUES ("Шар синий", 1000, 50,  "Шар круглый красный", "/images/balloons/blue_round_balloon.png", NOW(), NOW(), 1, 1);
INSERT INTO product_category (product_id, category_id) VALUES (2, 1);
INSERT INTO product_subcategory (product_id, subcategory_id) VALUES (2, 1);
INSERT INTO product (title, cost, quantity, description, img_link, created_date, last_modified_date, created_by, last_modified_by) VALUES ("Шар зеленый", 1000, 50,  "Шар круглый зеленый", "/images/balloons/green_round_balloon.png", NOW(), NOW(), 1, 1);
...
INSERT INTO product (title, cost, quantity, description, img_link, created_date, last_modified_date, created_by, last_modified_by) VALUES ("Шар желтый", 1000, 50,  "Шар круглый желтый", "/images/balloons/yellow_round_balloon.png", NOW(), NOW(), 1, 1);
