...
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Воздушные шары', 'balloons', 'Студия праздников HappyTime предлагает Вам огромный выбор воздушных шаров.', 'Устройте праздник для любимой, удивите любимого, порадуйте своих детей, подарите улыбку родным, доставьте удовольствие себе с шарами от студии праздников HappyTime. А состав студии поможет Вам в этом.' , NOW(), NOW(), 1, 1);
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Праздничные аксессуары', 'accessories',  'Аксессуары для праздников', 'У нас  Вы найдете множество отличных и незаменимых аксессуаров для любого праздника на любой вкус и цвет!', NOW(), NOW(), 1, 1);
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Оригинальные подарки', 'original-gifts',  'Оригинальные подарки ручной работы', 'Ищите, что подарить оригинального и необыного на день рождения, новый год или другой праздник? В нашей студии Вы можете приобрести эксклюзивные подарки ручной работы и даже заказать его изготовление по вашей идее!', NOW(), NOW(), 1, 1);
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Флористика', 'floristics',  'Букеты из цветов, бутоньерки и различные другие цветочные изделия.', 'В студии праздников HappyTime Вы можете заказать практические любое изделие из цветов, будь то простая бутоньерка на пиджак, или оригинальный и красивый букет для невесты.', NOW(), NOW(), 1, 1);
