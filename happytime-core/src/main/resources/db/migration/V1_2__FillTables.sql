...
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Аксессуары', 'accessories',  'Аксессуары для праздников', 'У нас  Вы найдете множество отличных и незаменимых аксессуаров для любого праздника на любой вкус и цвет!', NOW(), NOW(), 1, 1);
INSERT INTO category (title, code, description_title, description, created_date, last_modified_date, created_by, last_modified_by) VALUES ('Оригинальные подарки', 'original-gifts',  'Оригинальные подарки ручной работы', 'Ищите, что подарить оиригинального и необыного на день рождения, новый год или другой праздник? В нашей студии Вы можете приобрести эксклюзивные подарки ручной работы и даже заказать его изготовление по вашей идее!', NOW(), NOW(), 1, 1);
